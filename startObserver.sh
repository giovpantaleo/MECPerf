...
gradle -q :observer:run --args="--aggregator-ip "22.22.22.1" --aggregator-port 6766 --remote-ip  "22.22.22.2"  --remote-cmd-port 6789 --remote-tcp-port 6788 --remote-udp-port 6787 --observer-cmd-port 6792 --observer-tcp-port 6791 --observer-udp-port 6790"
